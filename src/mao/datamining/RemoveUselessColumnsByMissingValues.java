 ...
 */
public class RemoveUselessColumnsByMissingValues 
  extends Filter 
  ...
  /** The type of attribute to delete by missing percentage */
  protected double m_maxMissingPercentage = 90.0;
  
  private Set<String> column2DeleteSet = new HashSet();

    public double getM_maxMissingPercentage() {
        return m_maxMissingPercentage;
    }

    public void setM_maxMissingPercentage(double m_maxMissingPercentage) {
        this.m_maxMissingPercentage = m_maxMissingPercentage;
    }
...
//            System.out.println("stats.missingPercentage: " + (stats.missingCount*100)/stats.totalCount+"%");            
  ...
  public static void main(String [] argv) {
     RemoveUselessColumnsByMissingValues filter = new RemoveUselessColumnsByMissingValues(); 
     filter.setM_maxMissingPercentage(60);
     runFilter(filter, argv);
  }

    void setManualDeleteColumns(String[] columns2Delete) {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        this.column2DeleteSet.clear();
        this.column2DeleteSet.addAll(Arrays.asList(columns2Delete));
    }
}
